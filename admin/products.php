...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    if ($product && !empty($product['image'])) {
        ...
        if (file_exists($imagePath)) {
            unlink($imagePath);
            error_log("Видалено зображення: $imagePath");
        } else {
            error_log("Не вдалося знайти зображення для видалення: $imagePath");
        }
    }
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 main-content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div>
                        <a href="../fix-image-paths.php" class="btn btn-warning me-2" target="_blank">
                            <i class="fas fa-wrench"></i> Виправити шляхи
                        </a>
                                        ...
                                        <?php foreach ($products as $product): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $imagePath = !empty($product['image']) ? fixImagePath($product['image']) : 'uploads/no-image.png';
                                                    ...
                                                    // Для відображення в адмін-панелі додаємо шлях до кореня сайту
